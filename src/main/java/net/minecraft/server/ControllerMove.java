...
public class ControllerMove {
    ...
    // StarLink start
    public void doTick(ChunkCache cache) {
        float f;
        ...
        if (this.h == ControllerMove.Operation.STRAFE) {
            ...
            if (navigationabstract != null) {
                ...
                if (pathfinderabstract != null && pathfinderabstract.a(cache, MathHelper.floor(this.a.locX() + (double) f8), MathHelper.floor(this.a.locY()), MathHelper.floor(this.a.locZ() + (double) f)) != PathType.WALKABLE) {
                    this.f = 1.0F;
                    this.g = 0.0F;
                    f2 = f1;
                }
            ...
            this.a.o((float) (this.e * this.a.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue()));
            BlockPosition blockposition = new BlockPosition(this.a);
            IBlockData iblockdata = cache.getType(blockposition);
            Block block = iblockdata.getBlock();
            VoxelShape voxelshape = iblockdata.getCollisionShape(cache, blockposition);
