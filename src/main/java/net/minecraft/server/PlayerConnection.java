...
public class PlayerConnection implements PacketListenerPlayIn {
    ...
    private void internalTeleport(double d0, double d1, double d2, float f, float f1, Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> set) {
        ...
        this.player.playerConnection.networkManager.stream().writeAndFlush(new PacketPlayOutPosition(d0 - d3, d1 - d4, d2 - d5, f - f2, f1 - f3, set, this.teleportAwait)); // StarLink
    }
    ...
    public void a(PacketPlayInUpdateSign packetplayinupdatesign) {
        ...
        if (worldserver.isLoaded(blockposition)) {
            ...
            if (!tileentitysign.d() || tileentitysign.signEditor == null || !tileentitysign.signEditor.equals(this.player.getUniqueID())) { // StarLink - backport from Paper
