...
public class PathPoint {
    ...
    @ObfuscateHelper("x") // StarLink
    public final int a;
    @ObfuscateHelper("y") // StarLink
    public final int b;
    @ObfuscateHelper("z") // StarLink
    public final int c;
    @ObfuscateHelper("nodeHash") // StarLink
    private final int m;
    @ObfuscateHelper("indexInPath") // StarLink
    public int d = -1;
    public float e;
    @ObfuscateHelper("nearestDistanceWithOtherNodes") // StarLink
    public float f;
    public float g;
    @ObfuscateHelper("next|last") // StarLink
    public PathPoint h;
    public boolean i;
    public float j;
    public float k;
    ...
    @ObfuscateHelper("copyData") // StarLink
    ...
    @ObfuscateHelper("distanceSquared") // StarLink
