...
public class PathfinderGoalSelector {
    ...
    public synchronized void a(int i, PathfinderGoal pathfindergoal) {
        this.d.add(new PathfinderGoalWrapped(i, pathfindergoal));
    }

    public synchronized void a(PathfinderGoal pathfindergoal) {
    ...
    public synchronized Stream<PathfinderGoalWrapped> c() {
        return this.d.stream().filter(PathfinderGoalWrapped::g);
    }

    public synchronized void a(PathfinderGoal.Type pathfindergoal_type) {
        this.f.add(pathfindergoal_type);
    }

    public synchronized void b(PathfinderGoal.Type pathfindergoal_type) {
