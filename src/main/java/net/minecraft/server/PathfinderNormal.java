...
public class PathfinderNormal extends PathfinderAbstract {
    ...
    @ObfuscateHelper("speedInWater") // StarLink
    protected float j;

    public PathfinderNormal() {}

    @Override
    @ObfuscateHelper("setSpeedBy") // StarLink
    ...
    @Override
    @ObfuscateHelper("applySpeedForEntity") // StarLink
    public void a() {
    ...
    public PathPoint b() {
	@ObfuscateHelper("fixedY") // StarLink
        int i;
        ...
        if (this.b.a(pathtype) < 0.0F) {
            ...
            while (iterator.hasNext()) {
                ...
                @ObfuscateHelper("borderPathTypeWithFixedY") // StarLink
	...
	@ObfuscateHelper("measuredNodeAmount") // StarLink
        int i = 0;
        int j = 0;
        @ObfuscateHelper("pathTypeUp") // StarLink
        ...
        @ObfuscateHelper("westNode") // StarLink
        ...
        @ObfuscateHelper("eastNode") // StarLink
        ...
        @ObfuscateHelper("northNode") // StarLink
        ...
        @ObfuscateHelper("northWestNode") // StarLink
        ...
        @ObfuscateHelper("northEastNode") // StarLink
        ...
        @ObfuscateHelper("southWestNode") // StarLink
        ...
        @ObfuscateHelper("southEastNode") // StarLink
    ...
    @ObfuscateHelper("getDownwardHeight") // StarLink
    public static double a(IBlockAccess iblockaccess, @ObfuscateHelper("origin") BlockPosition blockposition) { // StarLink
    ...
    @Override
    @ObfuscateHelper("checkPathTypeFixedForEntity") // StarLink
    ...
    @ObfuscateHelper("checkPathTypeFixed") // StarLink
    ...
    @ObfuscateHelper("fixesPathType") // StarLink
    ...
    @Override
    @ObfuscateHelper("checkPathType") // StarLink
    ...
    @ObfuscateHelper("checkPathTypeAround") // StarLink
    ...
    @ObfuscateHelper("checkPathTypeAt") // StarLink
